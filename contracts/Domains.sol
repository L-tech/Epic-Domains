    ...
    function registerName(string calldata _name) public payable {
        ...
        bytes(
            ...
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A domain on the Meme Name service", "image": "data:image/svg+xml;base64,',
